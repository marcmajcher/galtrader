	...
	external long function smg$repaint_line(long by ref, long by ref, &
        ...
        external long function smg$erase_display(LONG, LONG, LONG, LONG, LON
G)
        external long function smg$unpaste_virtual_display(LONG, LONG)
        external long function smg$repaste_virtual_display(LONG,LONG,LONG,LO
NG)
        external long function smg$repaint_screen(LONG by ref)
        external long function smg$set_display_scroll_region(LONG, LONG, LON
G)
        external long function smg$delete_pasteboard (LONG by ref, LONG by r
ef)
 ...
 &
	    ...
	    rs=smg$ring_bell(error_id,1)	   `20
    ...
    sub handle_key(long keycode, string text_buffer, long text_len, prompt_l
en)
    %include "common.h"
    %include "display.e"
    ...
    ! ast_refresh routine to asynchrounously refresh screen.`20
